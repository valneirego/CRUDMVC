...
namespace crudMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d2 = new Department(2, "Electrinics");
            Department d3 = new Department(3, "Fashion");
            Department d4 = new Department(4, "Books");


            Seller s1 = new Seller(1, "Valnei Rego", "valneinfo@gmail.com", new DateTime(1987, 4, 21), 2000, d1);
            Seller s2 = new Seller(2, "Mariana Marcolino", "mah.isidro@hotmail.com,", new DateTime(1989, 6, 19), 1000, d2);
            Seller s3 = new Seller(3, "Julia Isidro", "julia@gmail.com", new DateTime(1950, 11, 21), 1200, d3);
            Seller s4 = new Seller(4, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s5 = new Seller(5, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Seller s6 = new Seller(6, "Alex Grey", "alex@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            Seller s7 = new Seller(7, "Martha Red", "martha@gmail.com", new DateTime(1993, 11, 30), 3000.0, d4);
            Seller s8 = new Seller(8, "Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
            Seller s9 = new Seller(9, "Alex Pink", "bob@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
